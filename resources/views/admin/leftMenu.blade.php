...
<div class="col-sm-4 col-md-4" style="padding-right: 0px;padding-left: 0px;">
    <ul class="list-group" style="box-shadow: 3px 4px 1px rgb(205,216,228);">
        ...
        <li class="list-group-item" style="background: rgb(255, 255, 255);"><i class="material-icons" style="font-size: 22px;width: 30px;color: rgb(241,130,0);">airline_seat_flat</i><span style="font-family: Alatsi, sans-serif;font-size: 18px;">Post</span></li>
    </ul>
</div>
